            ...
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (fuCompanyLogo.HasFile)
                    {
                        ...
                        {
                            lblMsg.Text = "please select .jpg, .png, .jpge file for Logo";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                    else
                ...
                {
                    query = "INSERT INTO Jobs (Title, NoOfPost, Description, Qualification, Experience, Specialization,LastDateToApply, Salary, JobType, CompanyName, CompanyImage, Website,Email, Address, Country, State, CreateDate)VALUES(@Title, @NoOfPost, @Description, @Qualification, @Experience, @Specialization,@LastDateToApply, @Salary, @JobType, @CompanyName, @CompanyImage, @Website, @Email, @Address, @Country, @State, @CreateDate)";
                    ;
                    type = "saved";
