<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMater.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="OnlineJobPortal.Admin.NewJob" %>
        ...
        <div class="container pt-4 pb-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-12 pt-3">
                    ...
                    <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" placeholder="Enterr Job Description" TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-12 pt-3">
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Enterr Work Location" TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4">
                <div class="col-md-3 col-md-ofset-2 mb-3">
