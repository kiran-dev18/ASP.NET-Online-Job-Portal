                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" placeholder="Ex: BCA with 9.2 Pointer"> </asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control" placeholder="Ex: MCA with 9.2 Pointer" ></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label>Resume</label>
                                    <asp:FileUpload ID="fuResume" CssClass="form-control pt-2" ToolTip=".doc , .docx, .pdf extension only" runat="server" />
                                </div>
                            </div>
