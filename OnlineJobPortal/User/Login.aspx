 ...
 <div class="col-lg-8 mx-auto">
     <div class="form-contact contact_form" novalidate="novalidate">
         <div class="row">
             ...
             <div class="col-12">
                 <div class="form-group">
                     ...
                     <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control" placeholder="Enter Unique Username" required="" OnTextChanged="txtUserName_TextChanged"></asp:TextBox>
                 </div>
             </div>
             <div class="col-sm-12">
                 <div class="form-group">
         ...
         <div class="form-group mt-3">
             ...
             <span class="clickLink"><a href="../User/Register.aspx">New User? Click Hear..</a></span>
         </div>
             </div>
          </div>
       </div>
